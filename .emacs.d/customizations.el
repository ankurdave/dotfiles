(custom-set-variables
 ...
 '(debug-on-error nil)
 '(default-frame-alist (quote ((cursor-type . box) (internal-border-width . 0) (modeline . t) (fringe) (mouse-color . "black") (background-mode . light) (tool-bar-lines . 0) (menu-bar-lines . 1) (right-fringe . 0) (left-fringe . 6) (cursor-color . "Red") (background-color . "White") (foreground-color . "Black") (font . "-apple-Monaco-medium-normal-normal-*-10-*-*-*-m-0-iso10646-1") (fontsize . 0) (font-backend ns))))
...
(custom-set-faces
 ...
 '(echo-area ((((type ns)) (:stipple nil :strike-through nil :underline nil :slant normal :weight normal :height 125 :width normal :family "Menlo"))))
